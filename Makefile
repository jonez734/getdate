...
override LDLIBS += $(shell ${PYTHON}-config --libs) -lpython3.9
...
%.h %.c : %.y
	${YACC} --warnings=all --defines=$*.h -o $*.c $<
%.o: %.c
	${CC} ${CFLAGS} ${CPPFLAGS} -c -o $@ $<
%.so:
	${CC} ${LDFLAGS} $^ ${LDLIBS} -o $@

libgetdate.so: getdate-parser.o getdate-lexer-original.o getdate-timezones.o pygetdate.o 
